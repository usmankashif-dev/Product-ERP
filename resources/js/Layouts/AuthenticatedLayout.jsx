...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                        ...
                        <div className="flex">
                            <div className="flex shrink-0 items-center">
                                <Link href="/" className="flex items-center space-x-2">
                                    ...
                                    />
                                    <span className="text-xl font-bold text-gray-800">Highlife</span>
                                </Link>
                            </div>
                            ...
                            <div className="hidden space-x-1 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    href="/reservations"
                                    active={window.location.pathname.startsWith('/reservations')}
                                    className="flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <NavLink
                                    href="/sales"
                                    active={window.location.pathname.startsWith('/sales')}
                                    className="flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {header && (
                <header className="border-b border-blue-100 bg-gradient-to-r from-blue-50 to-purple-50 shadow-sm animate-slideDown">
                    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                        <div className="text-gray-800 font-semibold text-lg">{header}</div>
                    </div>
                </header>
            )}
