        ...
        >
            ...
            <div className="py-12 bg-gray-50 min-h-screen">
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6">
                        <h1 className="text-3xl font-bold text-gray-900">New Return</h1>
                        <p className="mt-2 text-gray-600">Create a new product return</p>
                    </div>
                        ...
                        <div className="p-8">
                            <nav className="mb-6 pb-4 border-b border-gray-200">
                                <ol className="flex text-sm text-gray-500">
                                    ...
                                    <li className="mx-2">/</li>
                                    <li className="text-gray-900 font-medium">New Return</li>
                                </ol>
                            </nav>
