                        ...
                        <div className="p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="mb-4">
                                    ...
                                    {product.image && (
                                        <div className="mb-2">
                                            <img src={`/storage/${product.image}`} alt={product.name} className="w-32 h-32 object-cover rounded" />
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">Accepted formats: JPEG, PNG, JPG, GIF. Max size: 2MB. Leave empty to keep current image.</p>
                                </div>
                                <div className="pt-6 border-t border-gray-200">
                                    <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-lg transition shadow-sm">Update Product</button>
                                </div>
                            </form>
                        </div>
                    </div>
